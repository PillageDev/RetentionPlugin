...
public class GlobalSend extends Message {

    /**
     * Used to broadcast something for all player's inbox. The format for args param is as follows:
    ...
    public void send(MessageType type, Object... args) {
        ...
        for (RPlayer player : PlayerCache.getAllPlayers()) {
